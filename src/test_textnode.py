...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_link(self):
        node = TextNode("This is a link text node", TextType.LINK, "https://www.test.com")
        html_node = text_node_to_html_node(node)
    ...
    def test_text_image(self):
        node = TextNode("This is an image text node", TextType.IMAGE, "https://www.imagetest.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {"src": "https://www.imagetest.com", "alt": "This is an image text node"})
